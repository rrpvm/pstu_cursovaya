...
class MemoryKinoFilmsDataSource : KinofilmsDataSource {
    private val kinoList: Map<String, KinoModel> = listOf<KinoModel>(
        KinoModel(
    ...
    override suspend fun getAllAfishaKinoSessions(): List<KinoSessionModel> {
        ...
        return listOf<KinoSessionModel>(
            //Аватар
            KinoSessionModel(
                kinoModel = kinoList["5874b417-5417-4b01-be85-aa9f647bd35f"]!!,
            ...
            //Ронин
            KinoSessionModel(
                kinoModel = kinoList["cf65ed1d-b79a-460a-9606-1d2edaf3586c"]!!,
                sessionStartDate = Calendar.Builder().setDate(2025, 0, 8).setTimeOfDay(16, 30, 30)
                    .build().time,
            ...
            KinoSessionModel(
                kinoModel = kinoList["ebb65720-2389-4a7e-9fe3-7d1458d240a0"]!!,
            ...
            KinoSessionModel(
                kinoModel = kinoList["ebb65720-2389-4a7e-9fe3-7d1458d240a0"]!!,
                sessionStartDate = Calendar.Builder().setDate(2025, 0, 9).setTimeOfDay(21, 15, 0)
                    .build().time,
                sessionId = "fd7edc7a-7a9b-46a3-885e-d4973cbe546c"
            ),
            //Волшебник изумрудного города
            KinoSessionModel(
                kinoModel = kinoList["abb08203-ac9b-4467-9b76-dbb7d890e9b9"]!!,
                sessionStartDate = Calendar.Builder().setDate(2025, 0, 9).setTimeOfDay(22, 15, 0)
                    .build().time,
    ...
    override suspend fun getAllAfishaKinos(): List<KinoModel> {
