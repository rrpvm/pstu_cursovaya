...
@Database(
    entities = [UserEntity::class, KinoEntity::class, KinoSessionEntity::class, KinoFilmViewEntity::class, KinoGenreEntity::class, KinoGenreCrossRefEntity::class, AgeRatingEntity::class],
    version = 1
)
